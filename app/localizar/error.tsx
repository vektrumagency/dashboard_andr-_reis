...
export default function LocalizarError({ reset }: { reset: () => void }) {
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-col items-center px-6 py-24 text-center">
      <h1 className="text-xl font-semibold text-zinc-900">Não foi possível carregar Localizar</h1>
      <p className="mt-2 text-sm text-zinc-500">Tenta novamente dentro de alguns segundos.</p>
      <button
        type="button"
        onClick={reset}
